...
export default {
  ...
  methods: {
    ...
    goCreate() { uni.navigateTo({ url: '/pages/study/aidlearning/skills/detail?mode=create' }) },
    goDetail(name) { uni.navigateTo({ url: `/pages/study/aidlearning/skills/detail?name=${name}` }) },
  },
}
</script>
