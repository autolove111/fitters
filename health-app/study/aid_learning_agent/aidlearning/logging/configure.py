...
_CONFIGURED = False
_MANAGED_ATTR = "_aidlearning_managed"
...
def configure_logging(force: bool = False) -> LoggingConfig:
    ...
    logging.getLogger("aidlearning").setLevel(logging.DEBUG)
    logging.getLogger("aidlearning").propagate = True
