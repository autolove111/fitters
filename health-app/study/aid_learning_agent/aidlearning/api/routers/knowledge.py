...
from aidlearning.api.utils.task_id_manager import TaskIDManager
from aidlearning.api.utils.task_log_stream import capture_task_logs, get_task_stream_manager
from aidlearning.knowledge.add_documents import DocumentAdder
from aidlearning.knowledge.initializer import KnowledgeBaseInitializer
from aidlearning.knowledge.manager import KnowledgeBaseManager
from aidlearning.knowledge.naming import validate_knowledge_base_name
from aidlearning.knowledge.progress_tracker import ProgressStage, ProgressTracker
from aidlearning.multi_user.context import get_current_user
from aidlearning.multi_user.knowledge_access import (
    assert_writable,
    current_kb_base_dir,
    current_kb_manager,
...
from aidlearning.services.config import PROJECT_ROOT, load_config_with_main
from aidlearning.services.rag.factory import DEFAULT_PROVIDER
...
def _matching_index_is_valid(kb_name: str, matching_version: dict | None) -> bool:
    ...
    if not matching_version:
        return False
    try:
        from aidlearning.services.rag.pipelines.llamaindex.storage import (
