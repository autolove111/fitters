...
from aidlearning.multi_user.model_access import allowed_llm_options, redacted_model_access
from aidlearning.services.config import get_config_test_runner, get_model_catalog_service
from aidlearning.services.embedding.client import reset_embedding_client
from aidlearning.services.llm.client import reset_llm_client
from aidlearning.services.llm.config import clear_llm_config_cache
from aidlearning.services.model_selection import list_llm_options
from aidlearning.services.path_service import get_path_service
from aidlearning.tools.builtin import USER_TOGGLEABLE_TOOL_NAMES
...
def _provider_choices() -> dict[str, list[dict[str, str]]]:
    ...
    from aidlearning.services.config.provider_runtime import EMBEDDING_PROVIDERS
    from aidlearning.services.provider_registry import PROVIDERS
...
async def complete_tour(payload: TourCompletePayload | None = None):
    ...
    return {
        "status": "completed",
        "message": "Configuration saved. AidLearning will restart shortly.",
        "launch_at": launch_at,
