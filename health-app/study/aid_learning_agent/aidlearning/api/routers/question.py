...
from aidlearning.agents.question import AgentCoordinator
from aidlearning.api.utils.task_id_manager import TaskIDManager
from aidlearning.logging import (
    ProcessLogEvent,
    bind_log_context,
...
from aidlearning.tools.question import mimic_exam_questions
                ...
                if clean_message:
                    try:
                        event = ProcessLogEvent(
                            ...
                            logger="aidlearning.question.stdout",
