...
from aidlearning.core.capability_protocol import BaseCapability
from aidlearning.runtime.bootstrap.builtin_capabilities import BUILTIN_CAPABILITY_CLASSES
...
def _load_plugin_hooks():
    try:
        module = importlib.import_module("aidlearning.plugins.loader")
    except Exception:
