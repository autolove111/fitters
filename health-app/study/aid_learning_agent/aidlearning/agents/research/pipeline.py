...
from aidlearning.agents.research.data_structures import (
    DynamicTopicQueue,
    ToolTrace,
    TopicBlock,
    TopicStatus,
...
class ResearchPipeline:
    ...
    LLM call goes through :mod:`aidlearning.core.agentic` primitives. The
...
class _RephraseLoopHost:
    ...
    async def resolve_pause(self, dispatch: DispatchOutcome) -> bool:
        from aidlearning.agents.chat.agentic_pipeline import (
