...
to :mod:`aidlearning.core.agentic` and the shared tool-composition policy.
"""
...
from aidlearning.core.agentic.labels import find_inline_labels
...
from aidlearning.services.llm import get_llm_config, prepare_multimodal_messages
    ...
    async def _summarize_tool_result(
        ...
        *,
        ...
        meta = build_trace_metadata(
            ...
            label=self._t("labels.reflecting", default="AidLearning Reflecting..."),
        ...
        await stream.progress(
            self._t("labels.reflecting", default="AidLearning Reflecting..."),
            source=SOURCE,
            stage=STAGE_EXPLORING,
