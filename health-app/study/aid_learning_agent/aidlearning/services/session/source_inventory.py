...
from aidlearning.services.session.protocol import SessionStoreProtocol
...
async def build_inventory(
    ...
    *,
    ...
    — keeping side-effects (LLM summarisation, file I/O) under the
...
async def _load_question_entry(store: SessionStoreProtocol, entry_id: int) -> tuple[str, str]:
    ...
    from aidlearning.services.session.turn_runtime import _format_question_bank_entry
