"""LlamaIndex embedding adapter backed by AidLearning's embedding service."""
...
from aidlearning.services.embedding import EmbeddingConfig, get_embedding_client, get_embedding_config
from aidlearning.services.embedding.validation import validate_embedding_batch
...
class CustomEmbedding(BaseEmbedding):
    """Custom LlamaIndex embedding adapter for AidLearning embedding providers."""
...
def configure_llamaindex_settings(logger=None) -> None:
    """Configure LlamaIndex globals for AidLearning's current embedding config."""
