# AidLearning v1.2.1 Release Notes
...
- **CLI** — `/regenerate` (alias `/retry`) inside the `aidlearning chat` REPL.
...
**Full Changelog**: https://github.com/HKUDS/AidLearning/compare/v1.2.0...v1.2.1
