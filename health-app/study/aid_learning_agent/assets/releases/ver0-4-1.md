# 🔧 AidLearning v0.4.1 Release Notes
...
**Removed `aidlearning/core` module** - All functionality migrated to `aidlearning/services`:

| Old Import | New Import |
|:---|:---|
| `from aidlearning.core.core import load_config_with_main` | `from aidlearning.services.config import load_config_with_main` |
| `from aidlearning.core.llm_factory import llm_complete` | `from aidlearning.services.llm import complete` |
| `from aidlearning.core.prompt_manager import get_prompt_manager` | `from aidlearning.services.prompt import get_prompt_manager` |
| `from aidlearning.core.logging import get_logger` | `from aidlearning.logging import get_logger` |
...
**Full Changelog**: https://github.com/HKUDS/AidLearning/compare/v0.4.0...v0.4.1
