# AidLearning v1.3.2 Release Notes
...
Embedding configuration is now explicit about the exact URL AidLearning will call.
...
- **Settings now shows Endpoint URL for embeddings** - the Web settings page
  labels embedding URLs as endpoint URLs and explains that AidLearning posts to
...
**Full Changelog**: https://github.com/HKUDS/AidLearning/compare/v1.3.1...v1.3.2
