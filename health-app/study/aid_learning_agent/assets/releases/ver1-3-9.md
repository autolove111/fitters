# AidLearning v1.3.9 Release Notes
...
- **Minimal thinking mode is provider-safe** - DeepSeek, DashScope, VolcEngine,
  ...
  `reasoning_effort=minimal`; AidLearning sends the provider-specific disable
  signal instead.
...
- **`aidlearning start` launches the full web stack** - the CLI now delegates to
...
- Added CLI coverage so `aidlearning start` propagates the launcher exit code.
...
**Full Changelog**: https://github.com/HKUDS/AidLearning/compare/v1.3.8...v1.3.9
