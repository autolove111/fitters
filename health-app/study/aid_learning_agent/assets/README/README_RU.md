...
# AidLearning: Агент-нативное персонализированное обучение
...
[Возможности](#key-features) · [Начало работы](#get-started) · [Обзор](#explore-aidlearning) · [TutorBot](#tutorbot) · [CLI](#aidlearning-cli) · [Многопользовательский режим](#multi-user) · [Сообщество](#community)
...
>
> 🗺️ **Дорожная карта** ведётся в открытом виде на [`HKUDS/AidLearning#498`](https://github.com/HKUDS/AidLearning/issues/498) — комментируйте, чтобы голосовать за пункты или предлагать новые.

### 📦 Релизы

> **[2026.5.21]** [v1.4.0-beta](https://github.com/HKUDS/AidLearning/releases/tag/v1.4.0-beta) — Трёхслойный верстак Memory (L1/L2/L3), все возможности чата перестроены на едином агентном движке, RAG исключительно на LlamaIndex и единый интерфейс Settings + Capabilities.

> **[2026.5.10]** [v1.3.10](https://github.com/HKUDS/AidLearning/releases/tag/v1.3.10) — Восстановление CORS для удалённого Docker, `DISABLE_SSL_VERIFY` для SDK-провайдеров, более безопасные цитаты в блоках кода и опциональное дополнение Matrix E2EE.

> **[2026.5.9]** [v1.3.9](https://github.com/HKUDS/AidLearning/releases/tag/v1.3.9) — Поддержка Zulip и NVIDIA NIM для TutorBot, более безопасная маршрутизация моделей рассуждения, `aidlearning start`, подсказки в боковой панели и согласованность хранилища сессий.

> **[2026.5.8]** [v1.3.8](https://github.com/HKUDS/AidLearning/releases/tag/v1.3.8) — Опциональные многопользовательские развёртывания с изолированными рабочими пространствами, права администратора, маршруты аутентификации и ограниченный доступ во время выполнения.

<details>
<summary><b>Предыдущие релизы (более 2 недель назад)</b></summary>

> **[2026.5.4]** [v1.3.7](https://github.com/HKUDS/AidLearning/releases/tag/v1.3.7) — Исправления моделей рассуждения/провайдеров, видимая история индексов Knowledge, более безопасные очистка и редактирование шаблонов в Co-Writer.

> **[2026.5.3]** [v1.3.6](https://github.com/HKUDS/AidLearning/releases/tag/v1.3.6) — Выбор моделей на основе каталога для чата и TutorBot, более безопасная переиндексация RAG, исправления лимита токенов OpenAI Responses, валидация редактора Skills.

> **[2026.5.2]** [v1.3.5](https://github.com/HKUDS/AidLearning/releases/tag/v1.3.5) — Более гладкие настройки локального запуска, более безопасные RAG-запросы, чище аутентификация локальных эмбеддингов, полировка тёмного режима настроек.

> **[2026.5.1]** [v1.3.4](https://github.com/HKUDS/AidLearning/releases/tag/v1.3.4) — Сохранение чата на страницах книг и потоки восстановления, ссылки чат-книга, усиленная обработка языка/рассуждения, упрочнение извлечения документов RAG.

> **[2026.4.30]** [v1.3.3](https://github.com/HKUDS/AidLearning/releases/tag/v1.3.3) — Поддержка эмбеддингов NVIDIA NIM + Gemini, единый контекст Space (история чата/skills/память), снимки сессий, устойчивость переиндексации RAG.

> **[2026.4.29]** [v1.3.2](https://github.com/HKUDS/AidLearning/releases/tag/v1.3.2) — Прозрачные URL эндпоинтов эмбеддингов, устойчивость переиндексации RAG для невалидных персистентных векторов, очистка памяти от вывода моделей рассуждения, исправление выполнения Deep Solve.

> **[2026.4.28]** [v1.3.1](https://github.com/HKUDS/AidLearning/releases/tag/v1.3.1) — Стабильность: более безопасная маршрутизация RAG и валидация эмбеддингов, персистентность Docker, ввод с поддержкой IME, надёжность в Windows/GBK.

> **[2026.4.27]** [v1.3.0](https://github.com/HKUDS/AidLearning/releases/tag/v1.3.0) — Версионированные индексы KB с рабочим процессом переиндексации, перестроенное рабочее пространство Knowledge, авто-определение эмбеддингов с новыми адаптерами, хаб Space.

> **[2026.4.25]** [v1.2.5](https://github.com/HKUDS/AidLearning/releases/tag/v1.2.5) — Сохраняемые вложения чата с панелью предпросмотра файлов, конвейеры возможностей с учётом вложений, экспорт TutorBot в Markdown.

> **[2026.4.25]** [v1.2.4](https://github.com/HKUDS/AidLearning/releases/tag/v1.2.4) — Текстовые/кодовые/SVG вложения, Setup Tour одной командой, экспорт чата в Markdown, компактный UI управления KB.

> **[2026.4.24]** [v1.2.3](https://github.com/HKUDS/AidLearning/releases/tag/v1.2.3) — Вложения документов (PDF/DOCX/XLSX/PPTX), отображение блоков рассуждения, редактор шаблонов Soul, сохранение Co-Writer в notebook.

> **[2026.4.22]** [v1.2.2](https://github.com/HKUDS/AidLearning/releases/tag/v1.2.2) — Пользовательская система Skills, переработка производительности ввода чата, авто-запуск TutorBot, UI библиотеки книг, полноэкранная визуализация.

> **[2026.4.21]** [v1.2.1](https://github.com/HKUDS/AidLearning/releases/tag/v1.2.1) — Лимиты токенов по этапам, регенерация ответа во всех точках входа, исправления совместимости с RAG и Gemma.

> **[2026.4.20]** [v1.2.0](https://github.com/HKUDS/AidLearning/releases/tag/v1.2.0) — Компилятор «живых книг» Book Engine, многодокументный Co-Writer, интерактивные HTML-визуализации, @-упоминание Question Bank.

> **[2026.4.18]** [v1.1.2](https://github.com/HKUDS/AidLearning/releases/tag/v1.1.2) — Вкладка Channels на основе схемы, консолидация в единый RAG-конвейер, вынесенные prompt чата.

> **[2026.4.17]** [v1.1.1](https://github.com/HKUDS/AidLearning/releases/tag/v1.1.1) — Универсальный «Ответить сейчас», синхронизация прокрутки Co-Writer, единая панель настроек, кнопка Stop для стриминга.

> **[2026.4.15]** [v1.1.0](https://github.com/HKUDS/AidLearning/releases/tag/v1.1.0) — Переработка блочной математики LaTeX, диагностический зонд LLM, руководство по Docker + локальной LLM.

> **[2026.4.14]** [v1.1.0-beta](https://github.com/HKUDS/AidLearning/releases/tag/v1.1.0-beta) — Сессии с закладками URL, тема Snow, heartbeat WebSocket и автопереподключение, переработка реестра эмбеддингов.

> **[2026.4.13]** [v1.0.3](https://github.com/HKUDS/AidLearning/releases/tag/v1.0.3) — Тетрадь вопросов с закладками и категориями, Mermaid в Visualize, обнаружение несоответствия эмбеддингов, совместимость Qwen/vLLM, поддержка LM Studio и llama.cpp, тема Glass.

> **[2026.4.11]** [v1.0.2](https://github.com/HKUDS/AidLearning/releases/tag/v1.0.2) — Консолидация поиска с резервом SearXNG, исправление переключения провайдера, исправления утечек ресурсов фронтенда.

> **[2026.4.10]** [v1.0.1](https://github.com/HKUDS/AidLearning/releases/tag/v1.0.1) — Возможность Visualize (Chart.js/SVG), предотвращение дубликатов в quiz и поддержка модели o4-mini.

> **[2026.4.10]** [v1.0.0-beta.4](https://github.com/HKUDS/AidLearning/releases/tag/v1.0.0-beta.4) — Отслеживание прогресса эмбеддингов с повтором при превышении лимита, кросс-платформенные исправления зависимостей, исправление валидации MIME.

> **[2026.4.8]** [v1.0.0-beta.3](https://github.com/HKUDS/AidLearning/releases/tag/v1.0.0-beta.3) — Нативный SDK OpenAI/Anthropic (без litellm), поддержка Windows Math Animator, надёжный парсинг JSON и полная китайская i18n.

> **[2026.4.7]** [v1.0.0-beta.2](https://github.com/HKUDS/AidLearning/releases/tag/v1.0.0-beta.2) — Горячая перезагрузка настроек, вложенный вывод MinerU, исправление WebSocket и минимум Python 3.11+.

> **[2026.4.4]** [v1.0.0-beta.1](https://github.com/HKUDS/AidLearning/releases/tag/v1.0.0-beta.1) — Переписывание агент-нативной архитектуры (~200к строк): плагин-модель Tools + Capabilities, CLI и SDK, TutorBot, Co-Writer, Guided Learning и постоянная память.

> **[2026.1.23]** [v0.6.0](https://github.com/HKUDS/AidLearning/releases/tag/v0.6.0) — Постоянство сессий, инкрементальная загрузка документов, гибкий импорт RAG-конвейера и полная китайская локализация.

> **[2026.1.18]** [v0.5.2](https://github.com/HKUDS/AidLearning/releases/tag/v0.5.2) — Поддержка Docling для RAG-Anything, оптимизация системы логирования и исправления ошибок.

> **[2026.1.15]** [v0.5.0](https://github.com/HKUDS/AidLearning/releases/tag/v0.5.0) — Единая конфигурация сервисов, выбор RAG-конвейера на базу знаний, переработка генерации вопросов и настройка боковой панели.

> **[2026.1.9]** [v0.4.0](https://github.com/HKUDS/AidLearning/releases/tag/v0.4.0) — Поддержка многопровайдерных LLM и эмбеддингов, новая домашняя страница, развязка модуля RAG и рефакторинг переменных окружения.

> **[2026.1.5]** [v0.3.0](https://github.com/HKUDS/AidLearning/releases/tag/v0.3.0) — Единая архитектура PromptManager, CI/CD на GitHub Actions и предсобранные Docker-образы на GHCR.

> **[2026.1.2]** [v0.2.0](https://github.com/HKUDS/AidLearning/releases/tag/v0.2.0) — Развёртывание в Docker, обновление до Next.js 16 и React 19, усиление безопасности WebSocket и исправления критических уязвимостей.
...
> **[2026.4.10]** 📄 Наша статья теперь доступна на arXiv! Прочитайте [препринт](https://arxiv.org/abs/2604.26962), чтобы узнать больше о замысле и идеях, стоящих за AidLearning.

> **[2026.4.4]** Давно не виделись! ✨ AidLearning v1.0.0 наконец-то здесь — агент-нативная эволюция с полным переписыванием архитектуры с нуля, TutorBot и гибким переключением режимов под лицензией Apache-2.0. Начинается новая глава!

> **[2026.2.6]** 🚀 Мы достигли 10 тысяч звёзд всего за 39 дней! Огромное спасибо нашему невероятному сообществу за поддержку!

> **[2026.1.1]** С Новым годом! Присоединяйтесь к нашему [Discord](https://discord.gg/eRsjPgMU4t), [WeChat](https://github.com/HKUDS/AidLearning/issues/78) или [Discussions](https://github.com/HKUDS/AidLearning/discussions) — давайте вместе формировать будущее AidLearning!

> **[2025.12.29]** AidLearning официально выпущен!
...
- Space — личная библиотека для повторения, объединяющая историю чата, notebooks, банк вопросов и пользовательские skills (`SKILL.md`), которые переключают личность AidLearning.
- Трёхслойная память — append-only трассы L1, L2 факты, курируемые по поверхности с цитированием, и L3 межповерхностный синтез. Инспектируемый верстак и граф памяти позволяют вам аудировать *почему* AidLearning знает то, что он знает.
...
- Агент-нативная CLI — каждая возможность, KB, сессия и TutorBot в одной команде; богатый вывод для людей, структурированный JSON для агентов. Передайте [`SKILL.md`](../../SKILL.md) любому LLM с доступом к инструментам, и он сможет управлять AidLearning автономно.
...
AidLearning теперь имеет четыре параллельных пути установки. Все они используют один и тот же макет конфигурации времени выполнения:

- Настройки находятся в `data/user/settings/` под вашим текущим рабочим пространством или под `AIDLEARNING_HOME` / `aidlearning start --home`, когда вы выбираете его явно.
...
Для полного локального приложения рекомендуемый порядок: **выберите рабочее пространство → установите → `aidlearning init` → `aidlearning start`**.

### Вариант 1 — Установить AidLearning
...
> 🧪 **Пробуете v1.4.0 beta?** PyPI нормализует `1.4.0-beta` в `1.4.0b0`, так что `pip install -U aidlearning` останется на последней стабильной версии. Включите пре-релиз с помощью:
>
> ```bash
> pip install --pre -U aidlearning      # последний пре-релиз
> pip install -U aidlearning==1.4.0b0   # точно зафиксировать на v1.4.0-beta
> ```

`aidlearning init` записывает конфигурацию в `data/user/settings/` в каталоге, где вы её запускаете. Он спрашивает:
...
После `aidlearning start` откройте URL frontend, напечатанный в терминале. С портами по умолчанию это URL [http://127.0.0.1:3782](http://127.0.0.1:3782).

Держите терминал `aidlearning start` открытым. Нажмите `Ctrl+C` в этом терминале, чтобы остановить и backend, и frontend.

Примечания:

- `aidlearning start` запускает FastAPI backend и упакованный Next.js frontend вместе.
...
Используйте, когда разрабатываете AidLearning или хотите запускать прямо из checkout.
...
Если `aidlearning start` сообщает о существующем frontend, который не отвечает, удалите устаревшие файлы блокировки и запустите снова:
...
- `ghcr.io/hkuds/aidlearning:latest` — стабильный релиз
- `ghcr.io/hkuds/aidlearning:pre` — пре-релиз, когда доступен
...
Затем откройте [http://127.0.0.1:3782](http://127.0.0.1:3782). Конфигурация, API-ключи, логи, файлы рабочего пространства, память и базы знаний хранятся в томе `aidlearning-data` под `/app/data`.
...
Затем в **AidLearning Settings → Models** установите базовый URL провайдера на `host.docker.internal`:
...
`aidlearning init --cli` использует тот же макет `data/user/settings/`, что и полное приложение, но меняет поведение мастера:
...
- Спрашивает, настраивать ли эмбеддинги; ответ по умолчанию — `Нет`; выберите `Да`, если планируете использовать `aidlearning kb ...` или RAG-инструменты.
...
aidlearning run chat "Объясните преобразование Фурье"
aidlearning run deep_solve "Решите x^2 = 4" --tool rag --kb my-kb
...
Рефакторинг v1.4.0-beta реорганизует AidLearning вокруг **пяти основных поверхностей** — Chat, Co-Writer, Book, Knowledge, Space — плюс **трёхслойная Memory**, которая находится под ними всеми, и единый верстак **Settings**, открывающий все параметры. Возможности (Solve / Quiz / Research / Visualize) и инструменты (RAG, веб, код, рассуждение, мозговой штурм, поиск статей, `ask_user`, `web_fetch`, `write_note`, `list_notebook`, `github_query`) свободно компонуются поверх.
...
Дайте AidLearning тему, укажите ему вашу базу знаний, и он произведёт структурированную, интерактивную книгу — не статический экспорт, а живой документ, который вы можете читать, проверять себя по нему и обсуждать в контексте.
...
Память AidLearning теперь — это **трёхслойный конвейер** с инспектируемым верстаком на `/memory`.
...
- **Полный доступ к инструментам** — каждый бот обращается к полному набору инструментов AidLearning: извлечение RAG, выполнение кода, веб-поиск, поиск академических статей, глубокое рассуждение и мозговой штурм.
...
```bash
aidlearning bot create math-tutor --persona "Сократический учитель математики, использующий наводящие вопросы"
aidlearning bot create writing-coach --persona "Терпеливый, внимательный к деталям наставник по письму"
aidlearning bot list                  # Просмотреть всех ваших активных тьюторов
```

---

<a id="aidlearning-cli"></a>
### ⌨️ AidLearning CLI — Агент-нативный интерфейс

<div align="center">
<img src="../../assets/figs/cli-architecture.png" alt="AidLearning CLI Architecture" width="800">
</div>

AidLearning полностью CLI-нативен. Каждая возможность, база знаний, сессия, память и TutorBot — на расстоянии одной команды, без необходимости в браузере.

**Одноразовое выполнение**:

```bash
aidlearning run chat "Объясните преобразование Фурье" -t rag --kb textbook
aidlearning run deep_solve "Докажите, что √2 иррационально" -t reason
aidlearning run deep_question "Линейная алгебра" --config num_questions=5
aidlearning run deep_research "Механизмы внимания в трансформерах"
aidlearning run visualize "Нарисуйте архитектуру трансформера"
```
...
aidlearning kb search my-kb "градиентный спуск"
...
```bash
aidlearning run chat "Резюмируйте главу 3" -f rich    # Цветной, форматированный вывод
aidlearning run chat "Резюмируйте главу 3" -f json    # JSON-события с разделителями строк
```
...
| Команда | Описание |
|:---|:---|
| `aidlearning run <capability> <message>` | Запустить любую возможность за один ход (`chat`, `deep_solve`, `deep_question`, `deep_research`, `math_animator`, `visualize`) |
| `aidlearning chat` | Интерактивный REPL с опциональными `--capability`, `--tool`, `--kb`, `--language` |
| `aidlearning serve` | Запустить API-сервер AidLearning |

**`aidlearning bot`**

| Команда | Описание |
|:---|:---|
| `aidlearning bot list` | Список всех экземпляров TutorBot |
| `aidlearning bot create <id>` | Создать и запустить нового бота (`--name`, `--persona`, `--model`) |
| `aidlearning bot start <id>` | Запустить бота |
| `aidlearning bot stop <id>` | Остановить бота |

**`aidlearning kb`**

| Команда | Описание |
|:---|:---|
| `aidlearning kb list` | Список всех баз знаний |
| `aidlearning kb info <name>` | Показать детали базы знаний |
| `aidlearning kb create <name>` | Создать из документов (`--doc`, `--docs-dir`) |
| `aidlearning kb add <name>` | Добавлять документы инкрементально |
| `aidlearning kb search <name> <query>` | Искать в базе знаний |
| `aidlearning kb set-default <name>` | Установить как KB по умолчанию |
| `aidlearning kb delete <name>` | Удалить базу знаний (`--force`) |

**`aidlearning memory`**

| Команда | Описание |
|:---|:---|
| `aidlearning memory show [file]` | Просмотр памяти (`summary`, `profile` или `all`) |
| `aidlearning memory clear [file]` | Очистить память (`--force`) |

**`aidlearning session`**

| Команда | Описание |
|:---|:---|
| `aidlearning session list` | Список сессий (`--limit`) |
| `aidlearning session show <id>` | Просмотреть сообщения сессии |
| `aidlearning session open <id>` | Возобновить сессию в REPL |
| `aidlearning session rename <id>` | Переименовать сессию (`--title`) |
| `aidlearning session delete <id>` | Удалить сессию |

**`aidlearning notebook`**

| Команда | Описание |
|:---|:---|
| `aidlearning notebook list` | Список notebooks |
| `aidlearning notebook create <name>` | Создать notebook (`--description`) |
| `aidlearning notebook show <id>` | Просмотреть записи notebook |
| `aidlearning notebook add-md <id> <path>` | Импортировать markdown как запись |
| `aidlearning notebook replace-md <id> <rec> <path>` | Заменить запись markdown |
| `aidlearning notebook remove-record <id> <rec>` | Удалить запись |

**`aidlearning book`**

| Команда | Описание |
|:---|:---|
| `aidlearning book list` | Список всех книг в рабочем пространстве |
| `aidlearning book health <book_id>` | Проверить дрейф KB и здоровье книги |
| `aidlearning book refresh-fingerprints <book_id>` | Обновить отпечатки KB и очистить устаревшие страницы |

**`aidlearning config` / `plugin` / `provider`**

| Команда | Описание |
|:---|:---|
| `aidlearning config show` | Напечатать сводку текущей конфигурации |
| `aidlearning plugin list` | Список зарегистрированных инструментов и возможностей |
| `aidlearning plugin info <name>` | Показать детали инструмента или возможности |
| `aidlearning provider login <provider>` | Аутентификация провайдера |
...
Включите аутентификацию, и AidLearning превратится в многотенантное развёртывание с **изолированными рабочими пространствами на пользователя** и **курируемыми администратором ресурсами**. Первый зарегистрировавшийся становится администратором и настраивает модели, API-ключи и базы знаний от имени всех остальных.
...
| `data/user/settings/system.json` | Нет | `aidlearning start` выводит флаги auth frontend из runtime-настроек. |
...
AidLearning стоит на плечах выдающихся open-source проектов:

| Проект | Роль в AidLearning |
|:---|:---|
...
Мы надеемся, что AidLearning станет подарком для сообщества. 🎁
...
[⭐ Поставьте звезду](https://github.com/HKUDS/AidLearning/stargazers) · [🐛 Сообщить об ошибке](https://github.com/HKUDS/AidLearning/issues) · [💬 Обсуждения](https://github.com/HKUDS/AidLearning/discussions)
