...
from aidlearning.multi_user.context import reset_current_user, set_current_user
from aidlearning.multi_user.models import CurrentUser, UserScope
...
def mu_isolated_root(tmp_path, monkeypatch) -> Path:
    ...
    """
    from aidlearning.multi_user import grants, identity, paths
...
def make_user(mu_isolated_root):
    ...
    def _make(uid: str, *, role: str = "user", username: str | None = None) -> CurrentUser:
        from aidlearning.multi_user.paths import admin_scope
...
def seed_user(mu_isolated_root):
    ...
    def _seed(username: str, password: str = "password1234", role: str = "user") -> dict:
        ...
        from aidlearning.services.auth import hash_password
