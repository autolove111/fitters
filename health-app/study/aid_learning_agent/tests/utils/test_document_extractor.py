"""Tests for aidlearning.utils.document_extractor."""
...
from aidlearning.utils import document_extractor as document_extractor_module
from aidlearning.utils.document_extractor import (
    MAX_DOC_BYTES,
