...
def _load_question_extractor_module():
    ...
    stubbed_modules = {
        "aidlearning.services.config": {"get_agent_params": lambda *_args, **_kwargs: {}},
        "aidlearning.services.llm": {"complete": lambda *_args, **_kwargs: None},
        "aidlearning.services.llm.capabilities": {
            "supports_response_format": lambda *_args, **_kwargs: False
        },
        "aidlearning.services.llm.config": {"get_llm_config": lambda: None},
        "aidlearning.utils.json_parser": {"parse_json_response": lambda *_args, **_kwargs: {}},
    }
