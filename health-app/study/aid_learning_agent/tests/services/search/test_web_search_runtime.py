...
from aidlearning.services.config.provider_runtime import ResolvedSearchConfig
from aidlearning.services.search import web_search
from aidlearning.services.search.types import WebSearchResponse
...
def test_web_search_rejects_deprecated_provider(monkeypatch) -> None:
    monkeypatch.setattr(
        "aidlearning.services.search._get_web_search_config",
        lambda: {"enabled": True},
    )
    monkeypatch.setattr(
        "aidlearning.services.search.resolve_search_runtime_config",
...
def test_web_search_perplexity_missing_key_hard_fails(monkeypatch) -> None:
    ...
    monkeypatch.setattr("aidlearning.services.search._resolve_provider_key", lambda _p, _k: "")
...
def test_web_search_missing_key_falls_back_to_duckduckgo(monkeypatch) -> None:
    ...
    monkeypatch.setattr("aidlearning.services.search._resolve_provider_key", lambda _p, _k: "")
    monkeypatch.setattr("aidlearning.services.search.get_provider", _fake_get_provider)
