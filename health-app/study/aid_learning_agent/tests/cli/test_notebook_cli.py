"""CLI smoke tests for ``aidlearning notebook`` commands."""
...
def _patch_facade(monkeypatch) -> None:
    """Patch AidLearningApp methods to use the shared fake manager."""
    ...
    from aidlearning.app import facade

    monkeypatch.setattr(facade.AidLearningApp, "create_notebook", _create_notebook)
    monkeypatch.setattr(facade.AidLearningApp, "get_notebook", _get_notebook)
    monkeypatch.setattr(facade.AidLearningApp, "add_record", _add_record)
    monkeypatch.setattr(facade.AidLearningApp, "update_record", _update_record)
    monkeypatch.setattr(facade.AidLearningApp, "remove_record", _remove_record)
