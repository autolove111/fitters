...
PROVIDER_CMD = (ROOT / "aidlearning_cli" / "provider_cmd.py").read_text(encoding="utf-8")
CLI_README = (ROOT / "aidlearning_cli" / "README.md").read_text(encoding="utf-8")
...
class ProviderCliDocsContractTest(unittest.TestCase):
    ...
    def test_readmes_match_the_cli_contract(self) -> None:
        ...
        self.assertIn(
            "aidlearning provider login github-copilot    # 校验现有 GitHub Copilot 认证是否可用",
            CLI_README,
        )
